                    ...
                    <div className="mx-2 flex flex-wrap items-center justify-between">
                        <a href="#" className="flex mt-4 mx-8 mb-4">
                            <img
                                ...
                                className='h-10 mr-3'
                            />
                            <span className="text-[#2E3191] text-[24px] self-center text-lg font-semibold whitespace-nowrap">UCNE CHATBOT</span>
                        </a>
                        ...
                        <div className="hidden md:flex justify-between items-end w-full md:w-auto md:order-1 mx-8" id="mobile-menu-3">
            ...
            <div className="w-[70rem] mx-auto my-8">
                <div className="border-transparent rounded-lg overflow-hidden ">
                    <div className="flex flex-col h-[590px] ">
                        <div ref={messagesContainerRef} className="bg-transparent p-4 overflow-y-auto flex-1">
                            {messages.map((message) => (
                                <div className="relative" key={message.id}>
                                    <img
                                        ...
                                        alt="Avatar"
                                    />
                                    <div className={`w-full border border-gray-200 outline-none py-2 px-8 my-2 p-2 rounded-lg flex flex-col ${message.sender === 'user' ? 'bg-white-900 text-left' : 'bg-white-900 text-left'}`}>
                                        <div className="flex-grow">
                                            {dividirTextonumericoEnLineas(message.text, 75)}
                                        </div>
                                        {message.sender != 'user'?
                                        <div className="flex justify-end">
                                             <CopyToClipboard  text={dividirTextonumericoEnLineas(message.text, 75)} >
                                            <button><IoCopyOutline size={25} /></button>
                                            </CopyToClipboard>
                                        </div>:""}
                                    </div>
                        ...
                        <div className=" p-4 flex  flex-row items-center">
                            <div className="relative flex-1">
                                ...
                                >
                                    ...
                                    <TbArrowBadgeRightFilled className="mb-1" color="blue" size={40} />
                                </button>
                            </div>
                        </div>
